...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    @Query(value = "Select * " +
            ...
            "Where hpl.hotel_id = ro.hotel_id AND hpl.price >= ?8 AND hpl.price <= ?9) " +
            ...
            ")",nativeQuery = true)
    public Page<Room> returnRoomsThatAreAvailable(Long hotel_id, String arrivalDate, String departureDate, Long type, Integer people, Integer rooms,Integer beds, Integer minPrice, Integer maxPrice,Pageable pageable);
