...
public class EmailService{
    ...
    public void sendEmailAsync(User user, VerificationToken token) throws MailException, MessagingException {
        ...
        mailMessage.setSubject("eJourney account verification email");
        mailMessage.setFrom(environment.getProperty("spring.mail.username"));
        mailMessage.setSentDate(new Date());


        String text = "";
        text += user.getFirstName()+ ",\r\n\r\nYou are half way done, you just need to verify your account by clicking the link below.\r\n\r\n";
        text += "http://localhost:8080/auth/confirm?token="+ token.getToken();
